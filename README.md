...
And lastly to showcase the potential for real world usage: my living room from 10 images, captured with a Xiami Mi9 smartphone, without ground-truth Camera Parameters or Depth sensors (completely inferred from Colmap and monocular depth map prediction networks, scaled and matched to keypoints extracted from COLMAP).
